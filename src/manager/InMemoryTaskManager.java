...
public class InMemoryTaskManager implements TaskManager {
    ...
    //Сортированный список неповторяющихся задач
    private TreeSet<Task> timePriorityTaskList = new TreeSet<>(Comparator.comparing(Task::getStartTime,
    ...
    public Task getTask(Integer id) {
        if (Objects.nonNull(id) && taskMap.containsKey(id)) {
    ...
    public Epic getEpic(Integer id) {
        if (Objects.nonNull(id) && epicMap.containsKey(id)) {
    ...
    public SubTask getSubTask(Integer id) {
        if (Objects.nonNull(id) && subTaskMap.containsKey(id)) {
